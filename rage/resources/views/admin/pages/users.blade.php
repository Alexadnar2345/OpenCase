				...
				<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
					...
					<tbody>
						...
						<tr>
							...
							<td style="vertical-align: middle;"><a href="https://vk.com/id{{$user->vk_id}}" target="_blank">https://vk.com/id{{$user->vk_id}}</a></td>
							...
							<td align="center" style="vertical-align: middle;">
								...
								@if($user->is_banned == 0)
									<a class="btn red btn-sm" href="/admin/user/{{ $user->id }}/ban">Забанить</a>
								@else
									<a class="btn purple btn-sm" href="/admin/user/{{ $user->id }}/unban">Разабанить</a>
								@endif

        ...
        <div class="page-wrapper">
            <div class="page-header navbar navbar-fixed-top">
                <div class="page-header-inner ">
                    <div class="page-logo">
                        <a href="/admin">
                            <img src="{{asset('assets/admin/img/logo.png')}}" alt="logo" class="logo-default" /> </a>
                        ...
                        <ul class="nav navbar-nav pull-right">
                            <li class="dropdown dropdown-user">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <img alt="" class="img-circle" src="{{$u->avatar}}" />
                                    <span class="username username-hide-on-mobile"> {{$u->name}} </span>
                ...
                <div class="page-sidebar-wrapper">
                    <div class="page-sidebar navbar-collapse collapse">
                        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="false" data-slide-speed="200" style="padding-top: 20px">
                            ...
                            <li class="nav-item  ">
                                <a href="/admin/won" class="nav-link nav-toggle">
                                    <i class="icon-share-alt"></i>
                                    <span class="title">Предметы для отправки</span>
                                </a>
                            </li>
                            <li class="heading">
            ...
            <div class="page-footer">
                <div class="page-footer-inner"> 2016-2017 &copy;&nbsp; By &nbsp;
                    <a target="_blank" href="https://vk.com/s_info">S-INFO</a> &nbsp;&nbsp;
